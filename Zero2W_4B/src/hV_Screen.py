...
class Screen:
    ...
    # board.D refers to the GPIO, not the pin number
    # Touch
    # i2cSDA = already defined
    # i2cSCL = already defined
    touchINT = digitalio.DigitalInOut(board.D4)
    touchINT.direction = digitalio.Direction.INPUT
    touchRESET = digitalio.DigitalInOut(board.D17)
    touchRESET.direction = digitalio.Direction.OUTPUT
    i2cAddress = 0x41

    # Panel
    # spiSCK = already defined
    # spiMOSI = already defined
    # spiMISO = already defined
    panelCS = digitalio.DigitalInOut(board.D27)
    panelCS.direction = digitalio.Direction.OUTPUT
    flashCS = digitalio.DigitalInOut(board.D22)
    flashCS.direction = digitalio.Direction.OUTPUT
    panelRESET = digitalio.DigitalInOut(board.D23)
    panelRESET.direction = digitalio.Direction.OUTPUT
    panelDC = digitalio.DigitalInOut(board.D24)
    panelDC.direction = digitalio.Direction.OUTPUT
    panelBUSY = digitalio.DigitalInOut(board.D25)
    panelBUSY.direction = digitalio.Direction.INPUT
    ...
    def begin(self):
        ...
        # SPI
        self._spi.try_lock()
        self._spi.configure(baudrate=8000000)
        self._spi.unlock()
